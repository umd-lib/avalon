...
#    solr_doc['collection_sim'] = gather_terms(self.find_by_terms(:archival_collection))
    ...
    solr_doc['subject_person_ssim'] = gather_terms(self.find_by_terms(:person_subject))
    solr_doc['subject_corporate_ssim'] = gather_terms(self.find_by_terms(:corporate_subject))
