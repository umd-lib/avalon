...
module MediaObjectBehavior
  ...
  def umd_ip_manager_read_groups
    read_groups.select {|g| UmdIpManager::Group.valid_prefixed_key?(g) }
  end
  # End UMD Customization

  def virtual_read_groups
    # UMD Customization
    read_groups - represented_visibility - local_read_groups - ip_read_groups - umd_ip_manager_read_groups
    # End UMD Customization
  end
