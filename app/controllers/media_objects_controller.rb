...
class MediaObjectsController < ApplicationController
  ...
  before_action :authenticate_user!, except: [:show, :set_session_quality, :download_section, :show_stream_details]
  before_action :authenticate_api!, only: [:show, :create, :json_update], if: proc { request.format.json? }
  load_and_authorize_resource except: [:create, :json_update, :destroy, :update_status, :download_section, :set_session_quality, :tree, :deliver_content, :confirm_remove, :show_stream_details, :add_to_playlist_form, :add_to_playlist, :intercom_collections]
