...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    # UMD Customization
    current_user_is_manager = Proc.new {|context, _config, _opts| Ability.new(context.current_user, context.user_session).can? :create, MediaObject}
    ...
    config.add_facet_field 'has_transcripts_bsi', label: 'Has Transcripts', if: current_user_is_manager, group: "workflow", helper_method: :display_has_caption_or_transcript
